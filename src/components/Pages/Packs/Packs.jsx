    ...
    <div>
      <article className="container  pb-4 ">
        ...
        <p class="u-flowText">
          ...
          diferentes proyectos, que van desde el diseño web hasta el desarrollo
          de aplicaciones web empresariales.
        </p>
      </article>
            ...
            <div className="row">
              <div className="col-12 col-lg-6 offset-lg-6">
                ...
                <p className="u-TextSer pt-2">
                  ...
                  empresa, organización, producto o servicio de una manera
                  hermosa y moderna en Internet.
                </p>
                <a href="#interesado">
